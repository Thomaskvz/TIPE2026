...
for episode in range(1, episodes+1):
    ...
    while not done:
        ...
        # print("Action choisie :", action_map[action])
        ...
        if len(buffer)>32:
            ...
            states = states[:, hframe//2:, :]/255.0
            next_states = next_states[:, hframe//2:, :]/255.0
            ...
            for i in range(32):
                ...
                if not dones[i]:
                    target_reward += 0.99 * np.amax(next_q_values[i])
                q_values[i][actions[i]] = target_reward
