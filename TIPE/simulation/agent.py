...
class Agent:
    ...
    def __init__(self):
        ...
        self.model = Linear_QNet(49, 256, 3)
    ...
    def get_state(self, game):
        ...
        if dir_l:
            square = np.rot90(square, 3, axes=(0,1))
        elif dir_r:
            square = np.rot90(square, 1, axes=(0,1))
        elif dir_d:
            square = np.rot90(square, 2, axes=(0,1))

        state = square.flatten()
